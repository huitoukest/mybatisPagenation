...
public class DialectFactory {
    ...
    public static String buildPaginationSql(Pagination page, String buildSql, DBType dbType, String dialectClazz)
            throws Exception {
        // fix #172, 196
        return getDialect(dbType, dialectClazz).buildPaginationSql(buildSql, page.getOffset(), page.getPageSize());
    }
     ...
     * @throws Exception
     */
    public static IDialect getDialect(DBType dbType, String dialectClazz) throws Exception {
     ...
     * @throws Exception
     */
    private static IDialect getDialectByDbtype(DBType dbType) throws Exception {
        IDialect dialect;
        switch (dbType) {
            case MYSQL:

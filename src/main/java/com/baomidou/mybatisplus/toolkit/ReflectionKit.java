...
public class ReflectionKit {
    ...
    public static Object getMethodValue(Class<?> cls, Object entity, String str) throws Exception {
        ...
        try {
            ...
            throw new Exception(String.format("Error: NoSuchMethod in %s.  Cause:", cls.getSimpleName()) + e);
        } catch (IllegalAccessException e) {
            throw new Exception(String.format("Error: Cannot execute a private method. in %s.  Cause:",
                    cls.getSimpleName())
                    + e);
        } catch (InvocationTargetException e) {
            throw new Exception("Error: InvocationTargetException on getMethodValue.  Cause:" + e);
        }
    }
